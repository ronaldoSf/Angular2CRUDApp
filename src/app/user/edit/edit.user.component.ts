...
export class UserEditComponent extends DialogComponent implements OnInit {
  ...
  public usuario: Usuario = {codigo: 1, nome: "a", login: "s", senha: "d", perfilCod: 1, empresaCod: 2, perfilNome: "", empresaNome: "", testeEmpresa: new Empresa(3, "Umaa"), testeNumber: 80.798}
